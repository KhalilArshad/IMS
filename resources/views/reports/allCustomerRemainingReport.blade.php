            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Customers Remaining Report</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="row  mb-4">
                          <?php
                            ...
                            ?>
                            <form method="GET"  action="{{ url('getAllCustomerRemainingReport') }}" class="d-flex flex-wrap gap-2">
                            @csrf
                            <div class="col-sm-3">
                            ...
                            <div class="col-12">
                                    ...
                                    <div class="container border rounded">
                                        <table class="table">
                                            ...
                                            @foreach ($allRemaining  as $child)
                                            <tr>
                                                <td>{{ $i }}</td>
                                                <td>{{ $child->name }}</td>
                                                <td>{{ $child->phone_no}}</td>
                                                <td>{{ $child->previous_balance}}</td>
                                            </tr>
                                            @php($i++)
                                            @endforeach
                                            </tbody>
...
@section("script")
  ...
  $(document).ready(function() {
        ...
        $('#printReportBtn').click(function() {
            ...
            var printUrl = `${baseUrl}/allCustomerRemainingReportPrint?driver_id=${driverId}&customer_id=${customerId}`;
