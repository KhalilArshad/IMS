            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ url('customer-list') }}">Receive Payment Against Customer</a></li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body card-body-paddding">
                                ...
                                <form method="post" action="{{ url('SaveCustomerReceivable') }}" autocomplete="off">
                                    @csrf
                                       ...
                                       <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                              ...
                                              <input type="text" class="form-control" name='name' value="{{$customer->name}}" id="name" readonly placeholder="Enter name" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="previous_balance" class="form-label">Previous Balance<span
                                                    class="text-danger"> *</span></label>
                                                <input type="text" class="form-control" name='previous_balance' value="{{$customer->previous_balance}}" readonly id="previous_balance" placeholder="Enter Email" required>
